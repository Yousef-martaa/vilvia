...
/// affordance -- "Sign In" when signed out, or the account's email and a
/// sign-out control when signed in. Reactive via [AuthService]'s own
...
class HomeHeader extends StatefulWidget {
  const HomeHeader({super.key, this.authService});
          ...
          builder: (context, snapshot) {
            ...
            return Row(
              ...
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.logout, color: VilviaColors.charcoal),
                  tooltip: 'Sign out',
