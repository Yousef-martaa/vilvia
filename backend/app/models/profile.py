...
from app.models.enums import ChildStage, Gender, ParentRole, UserRole, str_enum
...
class Profile(Base):
    ...
    parent_role: Mapped[Optional[ParentRole]] = mapped_column(str_enum(ParentRole), nullable=True)
